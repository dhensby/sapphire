...
class ConfigCest
{
    ...
    public function testUpdateStatic(UnitTester $I)
    {
        ...
        $I->assertEquals(
            [ 'test_2' ],
            Config::inst()->get(Second::class, 'first', true)
        );
        $I->assertEquals(
            [
                'test_1',
        ...
        $I->assertEquals(
            ['test_1', 'test_1_2'],
            Config::inst()->get(First::class, 'first', true)
        );
        ...
        $I->assertEquals(
            ['test_4'],
            Config::inst()->get(Fourth::class, 'second', true)
        );
        $I->assertEquals(
        ...
        $I->assertEquals(
            ['test_3', 'test_3_2'],
            Config::inst()->get(Third::class, 'second', true)
        );
        ...
        $I->assertFalse(
            Config::inst()->exists(Third::class, 'second', true)
        );
