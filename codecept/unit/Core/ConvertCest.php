...
XML
    ...
    protected function providerTestSlashes()
    {
        return [
     ...
     */
    public function testSlashes(UnitTester $I, Example $example)
    {
        list($path, $separator, $multiple, $expected) = $example;
        $I->assertEquals($expected, Convert::slashes($path, $separator, $multiple));
    }
}
