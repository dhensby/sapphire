...
class ManifestFileFinderCest
{
    ...
    public function testBasicOperation(UnitTester $I)
    {
        ...
        $I->assertContains($this->defaultBase . '/vendor/myvendor/thismodule/module.txt', $found);
    }
    ...
    public function testIgnoreTests(UnitTester $I)
    {
        ...
        $I->assertContains($this->defaultBase . '/vendor/myvendor/thismodule/module.txt', $found);
        $I->assertContains($this->defaultBase . '/vendor/myvendor/thismodule/tests/tests.txt', $found);
        $I->assertContains($this->defaultBase . '/vendor/myvendor/thismodule/code/tests/tests2.txt', $found);
    }
